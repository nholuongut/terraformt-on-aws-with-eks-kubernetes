...
resource "helm_release" "external_dns" {
  ...
  set {
    name  = "provider" # Default is aws (https://github.com/nholuongut/external-dns/tree/master/charts/external-dns)
    value = "aws"
  }    

  set {
    name  = "policy" # Default is "upsert-only" which means DNS records will not get deleted even equivalent Ingress resources are deleted (https://github.com/nholuongut/external-dns/tree/master/charts/external-dns)
...
## References
- [External DNS Helm Chart](https://github.com/nholuongut/external-dns/tree/master/charts/external-dns)
- [External DNS Helm Chart Configuration](https://github.com/nholuongut/external-dns/tree/master/charts/external-dns#configuration)
- [External DNS + Ingress](https://github.com/nholuongut/external-dns/blob/master/docs/tutorials/alb-ingress.md)
- [External DNS on AWS](https://github.com/nholuongut/external-dns/blob/master/docs/tutorials/aws.md)
